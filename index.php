<?php
    ...
    $currentPage = isset($_GET['r']) ? $_GET['r'] : 'default'; // Jika parameter 'r' tidak ada, gunakan halaman default
...
<html lang="en">
  <head>
    ...
    <link href="assets\css\pages\select2.min.css" rel="stylesheet" />
    <script src="assets\js\pages\select2.min.js"></script>
    <script src="assets\css\pages\select2-bootstrap-5-theme.min.css"></script>
    <link
      rel="stylesheet"
        ...
        <footer>
          <div class="footer clearfix mb-0 text-muted">
            <div class="float-start">
              <p>2023 &copy; Informatika</p>
            </div>
            <div class="float-end">
              <p>
                Crafted with
                <span class="text-danger"><i class="bi bi-heart"></i></span> by
                <a href="https://www.linkedin.com/in/muhammad-ilham-kurniawan/" target='blank_'>Muhammad Ilham Kurniawan</a>
              </p>
            </div>
          </div>
        </footer>
