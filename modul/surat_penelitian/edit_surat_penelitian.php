          ...
          <div class="page-title">
            <div class="row">
              ...
              <h3>Surat Selesai Penelitian</h3>
                ...
                <div class="buttons">
                      <a href="index.php?r=surat_penelitian" class="btn btn-success">Kembali</a>
                </div>
              </div>
              ...
              <div>
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-title">Edit Surat Selesai Penelitian</h4>
                  </div>
                  <?php
                    $id=$_GET['id'];
                    $sqledit = "select * from surat_penelitian where no_surat = '".$id."'";
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-10 form-group">
                              <input
                                ...
                                value="<?php echo $show['namaDospem'];?>"
                                required
                              />
                            </div>
                            <div class="col-md-2">
